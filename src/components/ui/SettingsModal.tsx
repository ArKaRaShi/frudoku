  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-md max-h-[85vh] overflow-y-auto p-6 bg-white dark:bg-zinc-900 rounded-2xl shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
          <DialogPrimitive.Title className="text-2xl font-bold text-center mb-6 text-black dark:text-zinc-50">
            ตั้งค่า
